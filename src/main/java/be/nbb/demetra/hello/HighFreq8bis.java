 ...
 * @author Jean Palate
 */
public class HighFreq8bis {

    public static void main(String[] args) throws IOException {
         // the limit for the current implementation
        URL resource = HighFreq2.class.getResource("/deaths.txt");
        ...
        Matrix x1 = Holidays.france().fillDays(LocalDate.of(1968, Month.JANUARY, 1), m.getLength(), true);
        Matrix x2 = Holidays.france().fillPreviousWorkingDays(LocalDate.of(1968, Month.JANUARY, 1), m.getLength(), 1, true);
        Matrix x3 = Holidays.france().fillNextWorkingDays(LocalDate.of(1968, Month.JANUARY, 1), m.getLength(), 1, true);
...
//        outliersDetector.setDefault();
        ...
        x1 = Holidays.france().fillDays(nstart,731, true);
        x2 = Holidays.france().fillPreviousWorkingDays(nstart,731, 1, true);
        x3 = Holidays.france().fillNextWorkingDays(nstart,731, 1, true);
