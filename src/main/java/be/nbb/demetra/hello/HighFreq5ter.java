 ...
 * @author Jean Palate
 */
public class HighFreq5ter {

    public static void main(String[] args) throws IOException {

        URL resource = HighFreq2.class.getResource("/usclaims.txt");
...
//            M.column(i + 1).copy(sr.getComponent(ssf.getComponentPosition(i)));
        ...
        arsa.process(sa.drop(1,0), 140);
        ary.process(m.drop(1,0), 140);
        double rd = Math.PI/1000;
        double cur = rd;
